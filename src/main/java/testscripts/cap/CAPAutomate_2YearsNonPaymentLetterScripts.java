...
public class CAPAutomate_2YearsNonPaymentLetterScripts extends BaseClass {
	...
	public void Verifying_2YearsNonPaymentLetter(String environment, String clientName)
...
//		Thread.sleep(10000);
		...
		Scusttrxn = Scusttrxn.Select2YearsNonPaymentLetter();
		Thread.sleep(10000);
