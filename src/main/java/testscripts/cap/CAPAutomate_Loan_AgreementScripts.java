...
public class CAPAutomate_Loan_AgreementScripts extends BaseClass {
	...
	public void Verifying_Loan_Agreement(String environment, String clientName)
			throws InterruptedException, IOException, AWTException {

		strCustomerID = ExcelUtilities.getKeyValueFromExcelWithPosition("TestCaseData.xlsx", "CustomerSearch", "27", 1);
		strPaymentValue = ExcelUtilities.getKeyValueFromExcelWithPosition("TestCaseData.xlsx", "CustomerSearch", "27",
				2);
		...
		Scusttrxn = Scusttrxn.SelectLoanAgreementLetter();
		Thread.sleep(1000);
		...
		Thread.sleep(10000);
		//------------------------------------------------------------------>Changed by Rajesh
		Runtime.getRuntime().exec("D://Product//Autoit//EndPopup.exe");
		Thread.sleep(10000);
		Runtime.getRuntime().exec("D://Product//Autoit//PDFClose.exe");
		Thread.sleep(10000);
		Runtime.getRuntime().exec("D://Product//Autoit//LoanAgreementClose.exe");
		Thread.sleep(10000);
